...
#+Time-stamp: <2014-04-04 Fri 17:02>
#+DESCRIPTION:
#+KEYWORDS:
#+LANGUAGE:  en
...
Babel commands can now be used as *speed commands* when the point is on the
beginning of a code block!!

Org-babel is now making use of the newly available =C-c C-v= key binding.
All Org-babel keybindings are now located behind this prefix.
...
- ~C-c C-v C-i~ (or ~C-c C-v i~) ::
     Add all named code blocks from supplied file into the (in memory?)
     Library of Babel.
